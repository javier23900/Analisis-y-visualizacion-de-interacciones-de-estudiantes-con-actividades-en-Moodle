...
def configuracion(diccionario_tema, diccionario_estudiantes, diccionario_registros, documentos, fechas):
    ...
    for id in diccionario_registros.keys():
        estd.append(id)
    ...
    boton = Boton_grafica_registros(identificador, diccionario_registros, seleccion_fechas, fechas,
                                    estds, color, IP, opcion_grafica)
    ...
    boton2 = Boton_grafica_registros_pdf(identificador, diccionario_registros, seleccion_fechas, fechas,
                                         estudiantes, color, pdf, carpeta, IP, opcion_grafica)
